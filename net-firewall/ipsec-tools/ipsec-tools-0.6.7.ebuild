...
src_install() {
	...
	mkdir -p ${D}/usr/include/netinet
	install src/include-glibc/netinet/ipsec.h ${D}/usr/include/netinet/
	mkdir -p ${D}/usr/include/net
	install src/include-glibc/net/pfkeyv2.h ${D}/usr/include/net/
