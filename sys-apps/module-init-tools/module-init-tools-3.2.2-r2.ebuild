...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/module-init-tools/module-init-tools-3.2.2-r2.ebuild,v 1.10 2007/02/14 03:36:52 jer Exp $
...
DEPEND="sys-libs/zlib
	|| ( >=sys-apps/baselayout-1.12.7-r2 sys-apps/baselayout-lite)
	!virtual/modutils"
